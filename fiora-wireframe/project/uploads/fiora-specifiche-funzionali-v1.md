...
2. Il backend cerca prima nel catalogo curato (livello 1), poi in Trefle (livello 2) se i risultati sono insufficienti.
...
**Flussi alternativi:**
- Nessun risultato trovato → mostra "Specie non trovata" con opzione "Aggiungi specie mancante".
- Trefle non raggiungibile → mostra solo i risultati del catalogo curato con banner informativo.
...
6. Il backend verifica se la specie è presente su Trefle:
   - **Se trovata su Trefle:** viene aggiunta direttamente al catalogo condiviso con i dati Trefle integrati a quelli dell'utente.
